...
namespace Ham
{
    public static class BuildInfo
    {
        ...
        public const string Author = "BelugaTheAxolotl#2134 | https://discord.com/users/566770844286844953"; // Author of the Mod.  (MUST BE SET)
    ...
    public class HamMod : MelonMod
    {
        ...
        {
            icon = AssetBundle.LoadFromMemory(BVRhammers.Assets.hammeremoji).LoadAllAssets()[0].Cast<GameObject>();
        ...
        class Patch
        {
            public static bool Prefix(Collision mainCollision)
            {
                ...
                brick.GetComponent<Rigidbody>().AddExplosionForce(4 * mainCollision.relativeVelocity.magnitude, GameObject.Find("Hammer").transform.position, radius, 1f, ForceMode.Impulse);
                return false;
            }
        }
